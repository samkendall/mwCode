...
The main checkout defaults to `~/.mwcode/dev/userdata`. An explicit `--home-dir` wins in both cases.
Never run a development server against the live `~/.mwcode/userdata`.
