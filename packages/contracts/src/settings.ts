...
// The plain struct behind ClientSettingsSchema; consumers that need the field
// list (not the legacy-key pre-decode) read it here.
export const ClientSettingsStruct = Schema.Struct({
 ...
 */
export const ClientSettingsSchema = Schema.Record(Schema.String, Schema.Unknown).pipe(
  Schema.decodeTo(
    ...
    SchemaTransformation.transformEffect({
      ...
      encode: (value) => Effect.succeed(value as Record<string, unknown>),
    }),
  ),
);
