...
describe("DesktopEnvironment", () => {
  it.effect("derives state paths and development identity inside Effect", () =>
    Effect.gen(function* () {
      ...
      assert.equal(environment.appUserModelId, "net.samkendall.mwcode.dev");
      assert.equal(environment.linuxWmClass, "mwcode-dev");
      assert.equal(environment.linuxDesktopEntryName, "net.samkendall.mwcode.Development.desktop");
      assert.deepEqual(
  ...
  it.effect("uses the stable desktop entry as the packaged Linux portal identity", () =>
    Effect.gen(function* () {
      ...
      assert.equal(environment.linuxDesktopEntryName, "net.samkendall.mwcode.desktop");
    }),
  );
  ...
  it.effect("keeps implicit development state separate from production state", () =>
    Effect.gen(function* () {
      ...
      assert.equal(development.stateDir, "/Users/alice/.mwcode/dev");
      assert.equal(production.stateDir, "/Users/alice/.mwcode/userdata");
    }),
  );
