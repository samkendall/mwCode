...
export interface ProviderChangeRequestSummary {
  ...
  readonly isDraft?: boolean;
  /**
   * The host's rolled-up review verdict, where it can answer without extra work. Absent means the
   * host was not asked or does not summarise reviews — not that the change request has none.
   */
  readonly reviewDecision?: PullRequestReviewDecision | null | undefined;
  readonly closedAt?: string | null;
  readonly mergedAt?: string | null;
