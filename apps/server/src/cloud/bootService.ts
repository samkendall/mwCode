...
const BOOT_SERVICE_NAME = "mwcode";
export const BOOT_SERVICE_UNIT_FILE = `${BOOT_SERVICE_NAME}.service`;
// `.service` suffix keeps the label distinct from the desktop app's bundle id
// (net.samkendall.mwcode), so launchd and TCC records never collide.
export const BOOT_SERVICE_LAUNCHD_LABEL = "net.samkendall.mwcode.service";
