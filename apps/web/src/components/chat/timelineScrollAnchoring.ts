...
import type { TranscriptAutoCollapse } from "@t3tools/contracts/settings";
...
export interface RememberedTimelinePosition {
  ...
  readonly disclosures?: {
    /** Turn fold overrides, meaningful only under `turnFoldSetting`. */
    readonly turns: ReadonlySet<TurnId>;
    readonly turnFoldSetting?: TranscriptAutoCollapse;
